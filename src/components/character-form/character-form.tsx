...
const CharacterForm: FunctionComponent<Props> = ({character}) => {
    ...
    return (
        <Center>
            ...
            >
                ...
                /> : <Image
                        maxW={{ base: '100%', sm: '200px' }}
                        src={"https://imgs.search.brave.com/MmqzBUm8k37sW8I7es69kAqo1HubHcYXsNNPZ5rjE9U/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/c2VyaWVvdXNseS5j/b20vYXBwL3VwbG9h/ZHMvMjAyMy8wNy9q/YWNrLXNwYXJyb3ct/cGlyYXRlcy1kZXMt/Y2FyYWliZXMtMS5q/cGc"}
                        alt={'Nouveau personnage'}
                        borderRadius='lg'
                    />
                }
                <Stack>
